  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: '8px 8px 0 rgba(0,0,0,0.8), 0 0 30px rgba(57, 255, 20, 0.15)'
      }}
    >
      <div className="absolute -left-4 top-8 w-4 h-4" style={{ background: '#39FF14' }} />
      <div className="absolute -left-2 top-8 w-4 h-4" style={{ background: '#0D0D1A' }} />

      <div
        className="absolute inset-0 pointer-events-none opacity-15"
        style={{
          background: 'repeating-linear-gradient(0deg, rgba(57,255,20,0.08), rgba(57,255,20,0.08) 1px, transparent 1px, transparent 2px)'
        }}
      />
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <span
            ...
            style={{ fontFamily: "'Press Start 2P', cursive", color: '#39FF14', opacity: 0.4 }}
          >&gt;</span>
